...
describe('convertUnityProjectToJson', () => {
  it('should read all assets and scenes and return the project as json', async () => {
    ...
    expect(filenameMapping.blasterB.name).toEqual('blasterB');
    expect(filenameMapping.blasterB.ext).toEqual('fbx');
    expect(filenameMapping.blasterB.filename).toEqual('blasterB.fbx');
    expect(filenameMapping.blasterB.data).toStartWith('Z2xURgIAAADsdAAAOBUAAEpTT057CiJhc3NldCI6IHsKImdlbmVyYXRvciI6ICJGQlgyZ2xURiB2MC45LjciLAoidmVyc2lvbiI6IC');
  });
});
